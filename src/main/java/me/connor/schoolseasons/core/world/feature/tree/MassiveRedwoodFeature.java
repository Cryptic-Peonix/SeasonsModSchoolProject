...
public class MassiveRedwoodFeature extends MassiveTreesFeature<MassiveTreeFeatureConfig>{
    public MassiveRedwoodFeature(Function<Dynamic<?>, ? extends MassiveTreeFeatureConfig> p_i225797_1_) {
        super(p_i225797_1_);
    }

    protected boolean place(IWorldGenerationReader generationReader, Random rand, BlockPos positionIn, Set p_225557_4_, Set p_225557_5_, MutableBoundingBox boundingBoxIn, MassiveTreeFeatureConfig configIn) {
