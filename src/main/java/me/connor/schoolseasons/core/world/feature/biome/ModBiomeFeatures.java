...
public class ModBiomeFeatures {
    ...
    public static final TreeFeatureConfig REDWOOD_TREE_CONFIG = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(BlockInit.REDWOOD_LOG.getDefaultState()), new SimpleBlockStateProvider(BlockInit.REDWOOD_LEAVES.getDefaultState()), new BlobFoliagePlacer(5, 1))).baseHeight(6).heightRandA(5).foliageHeight(4).ignoreVines().setSapling((IPlantable) BlockInit.REDWOOD_SAPLING).build();
